...
namespace Eigen
{
  ...
  namespace internal
  {
    ...
    struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, ColMajor, ColMajor, ColMajor>
    {
      ...
      {
        typename remove_all<ResultType>::type _res;
        _res.resize(res.rows(), res.cols());
    ...
    // ─── the other specializations remain unchanged ─────────────────────────────────
    ...
    struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, ColMajor, RowMajor, RowMajor>
    {
                      ...
                      const RealScalar &tolerance)
      {
        ...
        sparse_sparse_product_with_pruning_selector<RowMajorMatrixLhs, Rhs, ResultType, RowMajor, RowMajor, RowMajor>(rowLhs, rhs, res, tolerance);
      }
    };
